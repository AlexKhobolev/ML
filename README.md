...
Будем рассматривать задачу классификации с двумя видами классов ![lin](https://user-images.githubusercontent.com/44859059/50448534-ed8d8380-0932-11e9-94c8-bd751fadd03c.png). Алгоритм ![lin2](https://user-images.githubusercontent.com/44859059/50448620-4e1cc080-0933-11e9-861f-fad7685c32ee.png) будет называться линейным алгоритмом классификации, который отделяет класс -1 от класса +1. Целью алгоритма является построение разделяющей прямой. Если объект распологается по одну сторону разделяющей прямой, то они принадлежат к одному классу, а если по другую - к другому. Уравнение *f(x, w)=0* задает разделяющую прямую, где w - вектор параметров.
