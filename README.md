...
Формула ![lin3](https://user-images.githubusercontent.com/44859059/50449469-a4403280-0938-11e9-8ff4-180af537ea1e.png) определяет эмпирический риск - количество ошибок на обучающей выборке. Функция *L* называется фукцией потерь, она непрерывна и неотрицательна.
